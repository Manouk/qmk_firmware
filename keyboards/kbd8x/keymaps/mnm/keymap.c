...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
      ...
      KC_LSPO, KC_NUBS, KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC, MO(1),                     KC_UP, \
      KC_LCTL, KC_LGUI, KC_LALT,         KC_SPC,                 KC_RALT, KC_RCTL, KC_MENU, KC_RCTL,                                     KC_LEFT, KC_DOWN, KC_RGHT),

    [1] = LAYOUT_all(
      _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MUTE, KC_MPLY, KC_MPRV, KC_MNXT, KC_MSTP, _______, _______, _______, _______,                   KC_PSCR, _______, KC_BRK, \
      ...
      KC_CAPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MSEL, \
      _______, _______, _______, _______, KC_CALC, _______, _______, _______, _______, _______, _______, _______, RSFT(KC_INS), _______,              _______, \
      _______, _______, _______,          _______,                   _______, _______, _______, DF(2),                                       _______, _______, _______),
    ...
    [2] = LAYOUT_all(
      ...
      KC_LSFT, KC_NUBS, KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, DF(0),                     KC_UP, \
