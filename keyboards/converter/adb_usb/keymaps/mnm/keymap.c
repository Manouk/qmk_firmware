...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_BSPC, KC_A,    KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_BSLS, KC_ENT,                                      KC_P4,   KC_P5,  KC_P6,   KC_PPLS,
    KC_LSFT, KC_LSFT, ALT_Z,   CTL_X,  KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, CTL_DOT, ALT_SLS,          KC_RSFT,                KC_UP,               KC_P1,   KC_P2,  KC_P3,
    ...
    _______, _______, _______, _______, RESET,   _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,    _______, _______, _______, _______,
