...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_ansi(
        ...
        KC_LSFT,          ALT_Z,   CTL_X,   KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, CTL_DOT, ALT_SLSH,KC_RSFT, KC_NO,                    KC_UP,               \
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_LALT, KC_RGUI, MO(_FL), KC_RCTL,      KC_LEFT,    KC_DOWN, KC_RGHT     \
    ),
    [_GL] = LAYOUT_ansi(
