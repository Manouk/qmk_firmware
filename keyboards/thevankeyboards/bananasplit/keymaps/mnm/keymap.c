...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DEFAULT_LAYER] = LAYOUT_all( \
    ...
    KC_LSFT, KC_NO,   KC_Z,    KC_X, KC_C,    KC_V,    KC_B,   KC_N, KC_M, KC_COMM, KC_DOT,  SFT_SLS, KC_UP,   MO(LAYER_1), \
    KC_LCTL, KC_LGUI, KC_LALT,       KC_LCTL, KC_LGUI, KC_SPC,             KC_RALT, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),
