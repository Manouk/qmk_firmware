...
[_BASE] = LAYOUT(
 ...
 KC_PGDN, KC_BSPC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H,   KC_J,   KC_K, KC_L,    KC_SCLN, KC_QUOT,          KC_ENT, \
          KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_END, KC_N,   KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(1), \
          KC_LCTL,    KC_LAPO, KC_LCTL, KC_LGUI,         KC_SPC,       KC_RAPC,                   KC_RCTRL \
   ),
[_FUNC] = LAYOUT(
...
RGB_RMOD, KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_UP, XXXXXXX, \
